Write-Host 'CODOR Constitutional Framework v4.0 - ACTIVE ENFORCEMENT' -ForegroundColor Cyan
Write-Host 'Project: generic | Constitution: v4.0' -ForegroundColor Green
...
$env:CODOR_LEVEL = '2'
$env:CODOR_PATH = 'D:\Dropbox\Repositories\Python\codor\test-slash-commands\.codor'
